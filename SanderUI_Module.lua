...
function SanderUI:CreateWindow(userConfig)
    ...
    local runService = game:GetService("RunService")
    local targetGui = runService:IsStudio() and player:WaitForChild("PlayerGui") or coreGui
    
    if targetGui:FindFirstChild("SanderUI") then
        screenGui = targetGui.SanderUI
    else
        -- ==========================================
        -- G2L ARAYÜZ OLUŞTURUCU (KENDİ KENDİNE OLUŞTURUR)
        -- ==========================================
        local G2L = {};
